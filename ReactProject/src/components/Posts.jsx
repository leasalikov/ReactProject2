                ...
                <div>
                    ...
                    {showPostsComments && (postsComments.map(comment => (
                        <li key={comment.id}>
                            ...
                            {comment.email == user.email ? <><button onClick={() => { DeleteComment(comment) }}>Delete</button>
                                <button onClick={() => { commentId.current = comment.id; setShowAAA(!showAAA) }}>Update</button></> : null}
                        </li>
                    )))}
                </div>
            )}
